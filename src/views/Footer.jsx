        ...
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            <div className="flex-shrink-0">
              <img className="h-8 w-8" src="/assets/3wag.png" alt="3Wag" /> 3Wag
            </div>
            <p />
            <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
              Somos una agencia líder en el mundo del marketing de influencers,
              especializada en conectar marcas con influencers de renombre para
              crear campañas de marketing auténticas y efectivas. Nuestro
              enfoque innovador en la Web3 nos permite ofrecer soluciones únicas
              y personalizadas que impulsan el crecimiento de las marcas en el
              mundo digital. Con una red global de influencers y un equipo
              experto en estrategia digital, estamos comprometidos en llevar el
              marketing de influencers al siguiente nivel. Únete a nosotros y
              descubre cómo podemos potenciar tu marca en la era digital.
            </p>
