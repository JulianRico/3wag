...
export default function Influncers() {
  return (
    <>
    <div className="flex flex-1   flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-gray-100 via-blue-50 to-blue-200 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
  ...
  Haz crecer tu marca como nunca antes
    ...
    <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
      ...
      <span className="relative">Con 3Wag</span>
    </span>
  </h1>
  <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
  ¡Descubre la innovación en Web3 para potenciar tu marca con influencers! Con nuestra plataforma, conecta con influencers líderes en tu industria y lleva tu estrategia de marketing al siguiente nivel. Únete a la revolución del networking con influencer.
  </h2>  
</div>
