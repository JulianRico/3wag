...
useLayoutEffect(() => {
  if(window.location.pathname.split('/')[3] === '7'){setError(true)}  
}, [])

    return(
        <>
        {error && <ErrorPage/>}
        {!error && <div className="max-w-4xl flex items-center h-auto  flex-wrap mx-auto my-32 lg:my-0">
  {/*Main Col*/}
  <div
    id="profile"
  ...
  >
    <div className="p-4 md:p-12 text-center lg:text-left">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("https://c.pxhere.com/photos/53/3d/business_man_work_businessman-1376514.jpg!d")'
        }}
      />
